...
var bot = function(config) {
  ...
  this.commands = (new Commands()).apply(this);
  this.thoughts = [];
}
...
bot.prototype = {
  ...
  activate : function(what) {
    this.commands.activate(what, function (err, result) {
      if (err) think_(err);
  ...
  */
  boot : function() {
    var self = this;
    console.log('Booting up: '+this.config.name);
