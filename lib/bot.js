...
=======
  ...
  // commands.bind(this);
>>>>>>> 63e5110f5ac1ea9469eba15f084b1b06f216e38d
  this.thoughts = [];
}
...
bot.prototype = {
  ...
  activate : function(what) {
    commands.activate(what, function(err) {
  ...
  */
  boot : function() {
    var self = this;
    console.log('Booting up: '+this.config.botName);
    ...
    commands.load(function onLoad(err) {
      ...
      self.activate({command: "scores",argument:"boot"});
  ...
  */
  post : function() {
    ...
    if (request.name===this.config.name)
  ...
  */
  postMessage : function(message) {
    ...
    if (message==undefined)
      return;
    console.log('sending: \'' + message.green + '\' to [' + this.config.GroupMe_group_name+']');
  ...
  */
  say : function(thought) {
    var self = this;
    if (!self.config.responding) return think_('Not responding w/: '+thought);
