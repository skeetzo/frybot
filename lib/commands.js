...
var commands = (function() {
  ...
  */
  ...
  function pregame() {
    ...
    console.log('players in pre: '+players_);
    var num = Math.round(Math.random()*players_.length);
    console.log('num: '+num);
    console.log('players len: '+players_.length);
    var player_ = players_[num];
    console.log('player at num: '+player_);
    say('Don\'t fuck it up '+player_+'!');
  };
