...
var commands = (function() {
  ...
  */
  ...
  function pregame() {
    ...
    bottle('duty');
    var players = league.getCurrentSeason().getPlayersByNames();
    console.log('players in pre: '+players);
    console.log('players len: '+players.length);
    var player = players[Math.random(0,players.length)];
    console.log('player in pre: '+player);
    say('Don\'t fuck it up '+player+'!');
  };
